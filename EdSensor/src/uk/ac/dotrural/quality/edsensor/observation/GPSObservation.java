...
public class GPSObservation extends Observation {
	...
	public GPSObservation(ObservationType property, String time, String lat, String lon, String sat, String prec, String event, boolean derived, ArrayList<Observation> derivedFrom)
	{
		super(property, time, "0", event, true, derivedFrom);
		setValues(lat, lon, sat, prec);
	}
	...
	public void describe()
	{
		...
		if(super.derivedObservation)
		{
			...
			{
				System.out.println("\nDerived from:");
				GPSObservation gps = (GPSObservation)super.derivedFrom.get(i);
				gps.describe();
			}
		}
	}
	...
	public StringBuilder followDerivationPath(String NS, GPSObservation obs, StringBuilder sb)
	{
		for(int i=0;i<obs.derivedFrom.size();i++)
		{
			GPSObservation derivedFromObs = (GPSObservation)obs.derivedFrom.get(i);
